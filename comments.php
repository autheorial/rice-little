...
<?php if ( have_comments() ) : ?><div class="commented">
...
<tr>
<td>
<div style="float:left; padding:0px 10px 0 0;"><?php echo get_avatar( $comment, $size = '100', $default ='http://i855.photobucket.com/albums/ab118/babygirlsaranghae/rice-3.jpg' ); ?>
</div>
</td>
...
<td>
 <a href="<?php comment_author_url(); ?>" class="author" target="_blank">
   ...
   <?php edit_comment_link('Edit',' &middot; ',''); ?></div>
</td></tr></table>
